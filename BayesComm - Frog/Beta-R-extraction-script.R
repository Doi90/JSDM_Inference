...
dataset_sd <- read.csv("Frogs_sd.csv")   # load in original data sd
...
write.csv(df, "Beta_df_Frog_BayesComm.csv")
write.csv(Sigma.mean, "Rho_mean_Frog_BayesComm.csv")
write.csv(Sigma.lower, "Rho_lower_Frog_BayesComm.csv")
write.csv(Sigma.upper, "Rho_upper_Frog_BayesComm.csv")
write.csv(Sigma.sd, "Rho_sd_Frog_BayesComm.csv")
write.csv(ess, "ess_Frog_BayesComm.csv")
