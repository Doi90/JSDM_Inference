...
write.csv(df_merge, "Beta_Fungi_boral.csv")
write.csv(rho.mean, "Rho_mean_Fungi_boral.csv")
write.csv(rho.lower, "Rho_lower_Fungi_boral.csv")
write.csv(rho.upper, "Rho_upper_Fungi_boral.csv")
write.csv(rho.sd, "Rho_sd_Fungi_boral.csv")