...
BayesComm_Rho_Mean <- read.csv("Rho_mean_Eucalypt_BayesComm.csv")
...
BayesComm_Rho_Lower <- read.csv("Rho_lower_Eucalypt_BayesComm.csv")
...
BayesComm_Rho_upper <- read.csv("Rho_upper_Eucalypt_BayesComm.csv")
...
Ovaskainen_Rho_Mean <- openxlsx::read.xlsx("R1_Eucalypt_Ovaskainen.xlsx",
                                           sheet = 1,
                                           colNames = TRUE)
...
Ovaskainen_Rho_Lower <- openxlsx::read.xlsx("R1_Eucalypt_Ovaskainen.xlsx",
                                            sheet = 5,
                                            colNames = TRUE)
...
Ovaskainen_Rho_Upper <- openxlsx::read.xlsx("R1_Eucalypt_Ovaskainen.xlsx",
                                            sheet = 6,
                                            colNames = TRUE)
...
OvaskainenNS_Rho_Mean <- openxlsx::read.xlsx("R1_Eucalypt_OvaskainenNS.xlsx",
                                             sheet = 1,
                                             colNames = TRUE)
...
OvaskainenNS_Rho_Lower <- openxlsx::read.xlsx("R1_Eucalypt_OvaskainenNS.xlsx",
                                              sheet = 5,
                                              colNames = TRUE)
...
OvaskainenNS_Rho_Upper <- openxlsx::read.xlsx("R1_Eucalypt_OvaskainenNS.xlsx",
                                              sheet = 6,
                                              colNames = TRUE)
...
Clark_Rho_Mean <- read.csv("Rho_mean_Eucalypts_Clark.csv")
...
Clark_Rho_Lower <- read.csv("Rho_lower_Eucalypts_Clark.csv")
...
Clark_Rho_upper <- read.csv("Rho_upper_Eucalypts_Clark.csv")
...
boral_Rho_Mean <- read.csv("Rho_mean_Eucalypt_boral.csv")
...
boral_Rho_Lower <- read.csv("Rho_lower_Eucalypt_boral.csv")
...
boral_Rho_upper <- read.csv("Rho_upper_Eucalypt_boral.csv")
...
pdf(file = "Correlation Plot Eucalypts.pdf", width = 14, height = 5.5)
