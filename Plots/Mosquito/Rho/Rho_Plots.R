...
Pollock_Rho_Mean <- read.csv("Rho_mean_Mosquito_Pollock.csv")
...
Pollock_Rho_Lower <- read.csv("Rho_lower_Mosquito_Pollock.csv")
...
Pollock_Rho_Upper <- read.csv("Rho_upper_Mosquito_Pollock.csv")
...
BayesComm_Rho_Mean <- read.csv("Rho_mean_Mosquito_BayesComm.csv")
rownames(BayesComm_Rho_Mean) <- BayesComm_Rho_Mean[,1]
...
BayesComm_Rho_Lower <- read.csv("Rho_lower_Mosquito_BayesComm.csv")
rownames(BayesComm_Rho_Lower) <- BayesComm_Rho_Lower[,1]
...
BayesComm_Rho_upper <- read.csv("Rho_upper_Mosquito_BayesComm.csv")
rownames(BayesComm_Rho_upper) <- BayesComm_Rho_upper[,1]
...
Ovaskainen_Rho_Mean <- openxlsx::read.xlsx("R1_Mosquito_Ovaskainen.xlsx",
                                           sheet = 1,
                                           colNames = TRUE)
...
Ovaskainen_Rho_Lower <- openxlsx::read.xlsx("R1_Mosquito_Ovaskainen.xlsx",
                                            sheet = 5,
                                            colNames = TRUE)
...
Ovaskainen_Rho_Upper <- openxsx::read.xlsx("R1_Mosquito_Ovaskainen.xlsx",
                                           sheet = 6,
                                           colNames = TRUE)
...
OvaskainenNS_Rho_Mean <- openxlsx::read.xlsx("R1_Mosquito_OvaskainenNS.xlsx",
                                             sheet = 1,
                                             colNames = TRUE)
rownames(OvaskainenNS_Rho_Mean) <- OvaskainenNS_Rho_Mean[,1]
...
OvaskainenNS_Rho_Lower <- openxlsx::read.xlsx("R1_Mosquito_OvaskainenNS.xlsx",
                                              sheet = 5,
                                              colNames = TRUE)
rownames(OvaskainenNS_Rho_Lower) <- OvaskainenNS_Rho_Lower[,1]
...
OvaskainenNS_Rho_Upper <- openxlsx::read.xlsx("R1_Mosquito_OvaskainenNS.xlsx",
                                              sheet = 6,
                                              colNames = TRUE)
rownames(OvaskainenNS_Rho_Upper) <- OvaskainenNS_Rho_Upper[,1]
...
Clark_Rho_Mean <- read.csv("Rho_mean_Mosquito_Clark.csv")
rownames(Clark_Rho_Mean) <- Clark_Rho_Mean[,1]
...
Clark_Rho_Lower <- read.csv("Rho_lower_Mosquito_Clark.csv")
rownames(Clark_Rho_Lower) <- Clark_Rho_Lower[,1]
...
Clark_Rho_upper <- read.csv("Rho_upper_Mosquito_Clark.csv")
rownames(Clark_Rho_upper) <- Clark_Rho_upper[,1]
...
boral_Rho_Mean <- read.csv("Rho_mean_Mosquito_boral.csv")
...
boral_Rho_Lower <- read.csv("Rho_lower_Mosquito_boral.csv")
...
boral_Rho_upper <- read.csv("Rho_upper_Mosquito_boral.csv")
...
pdf(file = "Correlation Plot Mosquitos.pdf", width = 18, height = 7)
par(mfrow = c(2,6), mar = c(4,2,4,2), oma = c(0.5,3,0,3))
