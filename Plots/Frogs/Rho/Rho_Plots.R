...
Pollock_Rho_Mean <- read.csv("Rho_mean_Frog_Pollock.csv")
...
Pollock_Rho_Lower <- read.csv("Rho_lower_Frog_Pollock.csv")
...
Pollock_Rho_Upper <- read.csv("Rho_upper_Frog_Pollock.csv")
...
BayesComm_Rho_Mean <- read.csv("Rho_mean_Frog_BayesComm.csv")
...
BayesComm_Rho_Lower <- read.csv("Rho_lower_Frog_BayesComm.csv")
...
BayesComm_Rho_upper <- read.csv("Rho_upper_Frog_BayesComm.csv")
...
Ovaskainen_Rho_Mean <- openxlsx::read.xlsx("R1_Frog_Ovaskainen.xlsx",
                                           sheet = 1,
                                           colNames = TRUE)
...
Ovaskainen_Rho_Lower <- openxlsx::read.xlsx("R1_Frog_Ovaskainen.xlsx",
                                            sheet = 5,
                                            colNames = TRUE)
...
Ovaskainen_Rho_Upper <- openxlsx::read.xlsx("R1_Frog_Ovaskainen.xlsx",
                                            sheet = 6,
                                            colNames = TRUE)
...
OvaskainenNS_Rho_Mean <- openxlsx::read.xlsx("R1_Frog_OvaskainenNS.xlsx",
                                             sheet = 1,
                                             colNames = TRUE)
...
OvaskainenNS_Rho_Lower <- openxlsx::read.xlsx("R1_Frog_OvaskainenNS.xlsx",
                                              sheet = 5,
                                              colNames = TRUE)
...
OvaskainenNS_Rho_Upper <- openxlsx::read.xlsx("R1_Frog_OvaskainenNS.xlsx",
                                              sheet = 6,
                                              colNames = TRUE)
...
Clark_Rho_Mean <- read.csv("Rho_mean_Frog_Clark.csv")
...
Clark_Rho_Lower <- read.csv("Rho_lower_Frog_Clark.csv")
...
Clark_Rho_upper <- read.csv("Rho_upper_Frog_Clark.csv")
...
boral_Rho_Mean <- read.csv("Rho_mean_Frog_boral.csv")
...
boral_Rho_Lower <- read.csv("Rho_lower_Frog_boral.csv")
...
boral_Rho_upper <- read.csv("Rho_upper_Frog_boral.csv")
...
png(filename = "Correlation Plot Frogs.png", units = "in", width = 12, height = 7, res = 300)

#pdf(file = "Correlation Plot Frogs.pdf", width = 12, height = 5)
