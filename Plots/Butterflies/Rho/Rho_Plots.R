...
BayesComm_Rho_Mean <- read.csv("Rho_mean_Butterfly_BayesComm.csv")
...
BayesComm_Rho_Lower <- read.csv("Rho_lower_Butterfly_BayesComm.csv")
...
BayesComm_Rho_upper <- read.csv("Rho_upper_Butterfly_BayesComm.csv")
...
OvaskainenNS_Rho_Mean <- openxlsx::read.xlsx("R1_Butterfly_OvaskainenNS.xlsx",
                                             sheet = 1,
                                             colNames = TRUE)
...
OvaskainenNS_Rho_Lower <- openxlsx::read.xlsx("R1_Butterfly_OvaskainenNS.xlsx",
                                              sheet = 5,
                                              colNames = TRUE)
...
OvaskainenNS_Rho_Upper <- openxlsx::read.xlsx("R1_Butterfly_OvaskainenNS.xlsx",
                                              sheet = 6,
                                              colNames = TRUE)
...
Clark_Rho_Mean <- read.csv("Rho_mean_Butterflies_Clark.csv")
...
Clark_Rho_Lower <- read.csv("Rho_lower_Butterflies_Clark.csv")
...
Clark_Rho_upper <- read.csv("Rho_upper_Butterflies_Clark.csv")
...
boral_Rho_Mean <- read.csv("Rho_mean_Butterfly_boral.csv")
...
boral_Rho_Lower <- read.csv("Rho_lower_Butterfly_boral.csv")
...
boral_Rho_upper <- read.csv("Rho_upper_Butterfly_boral.csv")
...
pdf(file = "Correlation Plot Butterflies.pdf", width = 24, height = 15)
