...
Pollock_Rho_Mean <- read.csv("Rho_mean_Fungi_Pollock.csv")
...
Pollock_Rho_Lower <- read.csv("Rho_lower_Fungi_Pollock.csv")
...
Pollock_Rho_Upper <- read.csv("Rho_upper_Fungi_Pollock.csv")
...
BayesComm_Rho_Mean <- read.csv("Rho_mean_Fungi_BayesComm.csv")
...
BayesComm_Rho_Lower <- read.csv("Rho_lower_Fungi_BayesComm.csv")
...
BayesComm_Rho_upper <- read.csv("Rho_upper_Fungi_BayesComm.csv")
...
# 
# Ovaskainen_Rho_Mean <- read.xlsx("R1_Frog_Ovaskainen.xlsx",sheetIndex = 1, header = T)
...
# 
# Ovaskainen_Rho_Lower <- read.xlsx("R1_Frog_Ovaskainen.xlsx",sheetIndex = 5, header = T)
...
# 
# Ovaskainen_Rho_Upper <- read.xlsx("R1_Frog_Ovaskainen.xlsx",sheetIndex = 6, header = T)
...
OvaskainenNS_Rho_Mean <- openxlsx::read.xlsx("R1_Fungi_OvaskainenNS.xlsx",
                                             sheet = 1,
                                             colNames = TRUE)
...
OvaskainenNS_Rho_Lower <- openxlsx::read.xlsx("R1_Fungi_OvaskainenNS.xlsx",
                                              sheet = 5,
                                              colNames = TRUE)
...
OvaskainenNS_Rho_Upper <- openxlsx::read.xlsx("R1_Fungi_OvaskainenNS.xlsx",
                                              sheet = 6,
                                              colNames = TRUE)
...
Clark_Rho_Mean <- read.csv("Rho_mean_Fungi_Clark.csv")
...
Clark_Rho_Lower <- read.csv("Rho_lower_Fungi_Clark.csv")
...
Clark_Rho_upper <- read.csv("Rho_upper_Fungi_Clark.csv")
...
boral_Rho_Mean <- read.csv("Rho_mean_Fungi_boral.csv")
...
boral_Rho_Lower <- read.csv("Rho_lower_Fungi_boral.csv")
...
boral_Rho_upper <- read.csv("Rho_upper_Fungi_boral.csv")
...
pdf(file = "Correlation Plot Fungi.pdf", width = 12, height = 5.3)
par(mfrow = c(2,5), mar = c(4,2,4,2), oma = c(0.5,3,0,3))
