...
write.csv(df, "Beta_df_Birds_BayesComm.csv")
write.csv(Sigma.mean, "Rho_mean_Birds_BayesComm.csv")
write.csv(Sigma.lower, "Rho_lower_Birds_BayesComm.csv")
write.csv(Sigma.upper, "Rho_upper_Birds_BayesComm.csv")
write.csv(Sigma.sd, "Rho_sd_Birds_BayesComm.csv")
write.csv(ess, "ess_Birds_BayesComm.csv")
