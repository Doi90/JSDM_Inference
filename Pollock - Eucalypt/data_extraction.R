...
write.csv(df, "Beta_Eucalypt_Pollock.csv")
write.csv(rho.mean, "Rho_mean_Eucalypt_Pollock.csv")
write.csv(rho.lower, "Rho_lower_Eucalypt_Pollock.csv")
write.csv(rho.upper, "Rho_upper_Eucalypt_Pollock.csv")
write.csv(rho.sd, "Rho_sd_Eucalypt_Pollock.csv")
