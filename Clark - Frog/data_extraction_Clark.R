...
write.csv(df_merge, "Beta_Frog_Clark.csv")
write.csv(mean.corr, "Rho_mean_Frog_Clark.csv")
write.csv(lower.corr, "Rho_lower_Frog_Clark.csv")
write.csv(upper.corr, "Rho_upper_Frog_Clark.csv")
write.csv(sd.corr, "Rho_sd_Frog_Clark.csv")
