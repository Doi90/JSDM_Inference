...
write.csv(df_merge, "Beta_Frog_boral.csv")
write.csv(rho.mean, "Rho_mean_Frog_boral.csv")
write.csv(rho.lower, "Rho_lower_Frog_boral.csv")
write.csv(rho.upper, "Rho_upper_Frog_boral.csv")
write.csv(rho.sd, "Rho_sd_Frog_boral.csv")