setwd("C:/Users/David/Dropbox/JSDM/JSDM Comparison Compiled/Sampler Efficiency Comparison/Ovaskainen 2016 - Mosquito/examples/Mosquito/posteriors")
...
write.csv(ess.B, "ess_beta_Mosquito_Ov.csv")
