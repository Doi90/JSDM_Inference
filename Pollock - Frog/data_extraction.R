...
write.csv(df, "Beta_Frog_Pollock.csv")
write.csv(rho.mean, "Rho_mean_Frog_Pollock.csv")
write.csv(rho.lower, "Rho_lower_Frog_Pollock.csv")
write.csv(rho.upper, "Rho_upper_Frog_Pollock.csv")
write.csv(rho.sd, "Rho_sd_Frog_Pollock.csv")
write.csv(ess, "ess_Frog_Pollock.csv")
