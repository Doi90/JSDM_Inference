...
write.csv(df_merge, "Beta_Eucalypt_boral.csv")
write.csv(rho.mean, "Rho_mean_Eucalypt_boral.csv")
write.csv(rho.lower, "Rho_lower_Eucalypt_boral.csv")
write.csv(rho.upper, "Rho_upper_Eucalypt_boral.csv")
write.csv(rho.sd, "Rho_sd_Eucalypt_boral.csv")