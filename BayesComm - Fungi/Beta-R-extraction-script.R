...
##############################
## For loop data extraction ## standardised
##############################
...
write.csv(df, "Beta_df_Fungi_BayesComm.csv")
write.csv(Sigma.mean, "Rho_mean_Fungi_BayesComm.csv")
write.csv(Sigma.lower, "Rho_lower_Fungi_BayesComm.csv")
write.csv(Sigma.upper, "Rho_upper_Fungi_BayesComm.csv")
write.csv(Sigma.sd, "Rho_sd_Fungi_BayesComm.csv")
write.csv(ess, "ess_Fungi_BayesComm.csv")
