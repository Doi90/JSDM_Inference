...
write.csv(df_merge, "Beta_Eucalypts_Clark.csv")
write.csv(mean.corr, "Rho_mean_Eucalypts_Clark.csv")
write.csv(lower.corr, "Rho_lower_Eucalypts_Clark.csv")
write.csv(upper.corr, "Rho_upper_Eucalypts_Clark.csv")
write.csv(sd.corr, "Rho_sd_Eucalypts_Clark.csv")
