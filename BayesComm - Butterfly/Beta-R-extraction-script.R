...
write.csv(df, "Beta_df_Butterfly_BayesComm.csv")
write.csv(Sigma.mean, "Rho_mean_Butterfly_BayesComm.csv")
write.csv(Sigma.lower, "Rho_lower_Butterfly_BayesComm.csv")
write.csv(Sigma.upper, "Rho_upper_Butterfly_BayesComm.csv")
write.csv(Sigma.sd, "Rho_sd_Butterfly_BayesComm.csv")
write.csv(ess, "ess_Butterfly_BayesComm.csv")
