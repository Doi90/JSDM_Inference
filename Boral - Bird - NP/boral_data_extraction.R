...
write.csv(df_merge, "Beta_Bird_boral.csv")
write.csv(rho.mean, "Rho_mean_Bird_boral.csv")
write.csv(rho.lower, "Rho_lower_Bird_boral.csv")
write.csv(rho.upper, "Rho_upper_Bird_boral.csv")
write.csv(rho.sd, "Rho_sd_Bird_boral.csv")