...
write.csv(df_merge, "Beta_Butterflies_Clark.csv")
write.csv(mean.corr, "Rho_mean_Butterflies_Clark.csv")
write.csv(lower.corr, "Rho_lower_Butterflies_Clark.csv")
write.csv(upper.corr, "Rho_upper_Butterflies_Clark.csv")
write.csv(sd.corr, "Rho_sd_Butterflies_Clark.csv")
