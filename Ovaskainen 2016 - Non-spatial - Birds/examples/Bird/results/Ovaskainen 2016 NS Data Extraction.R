...
file.mean <- openxlsx::read.xlsx("beta_Bird.xlsx", 1, colNames = TRUE)
file.lower <- read.xlsx("beta_Bird.xlsx",5, colNames = TRUE)
file.upper <- read.xlsx("beta_Bird.xlsx",6, colNames = TRUE)
beta <- read.csv("beta_Bird.csv", header = FALSE)

# Load standardisation data

dataset_sd <- read.csv("Birds_sd.csv")
...
write.csv(df,"Beta_Bird_Ovaskainen2016NS.csv")
