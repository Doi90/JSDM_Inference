...
file.mean <- read.xlsx("beta_Frog.xlsx",1, header=T)
file.lower <- read.xlsx("beta_Frog.xlsx",5, header=T)
file.upper <- read.xlsx("beta_Frog.xlsx",6, header=T)
