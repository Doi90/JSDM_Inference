...
file.mean <- openxlsx::read.xlsx("beta_Frog.xlsx", 1, colNames = TRUE)
file.lower <- read.xlsx("beta_Frog.xlsx",5, colNames = TRUE)
file.upper <- read.xlsx("beta_Frog.xlsx",6, colNames = TRUE)
beta <- read.csv("beta_Frog.csv", header = FALSE)

# Load standardisation data

dataset_sd <- read.csv("Frogs_sd.csv")
...
write.csv(df,"Beta_Frog_Ovaskainen2016NS.csv")
